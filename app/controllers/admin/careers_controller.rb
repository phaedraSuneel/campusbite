class Admin::CareersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @career.save
        format.html { redirect_to admin_career_path(@career), notice: 'Career was successfully created.' }
        format.json { render json: @career, status: :created, location: admin_career_path(@career) }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @career.update_attributes(params[:career])
        format.html { redirect_to admin_career_path(@career), notice: 'Career was successfully updated.' }
