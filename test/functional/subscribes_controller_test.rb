...
class SubscribesControllerTest < ActionController::TestCase
  ...
  test "should create subscribe" do
    assert_difference('Subscribe.count') do
      post :create, subscribe: { email: @subscribe.email, name: @subscribe.name, school_name: @subscribe.school_name }
    end
  ...
  test "should update subscribe" do
    put :update, id: @subscribe, subscribe: { email: @subscribe.email, name: @subscribe.name, school_name: @subscribe.school_name }
    assert_redirected_to subscribe_path(assigns(:subscribe))
  end
