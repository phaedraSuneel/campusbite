...
class CareersControllerTest < ActionController::TestCase
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post :create, career: { location: @career.location, responsibilities: @career.responsibilities, title: @career.title }
    end
  ...
  test "should update career" do
    put :update, id: @career, career: { location: @career.location, responsibilities: @career.responsibilities, title: @career.title }
    assert_redirected_to career_path(assigns(:career))
  end
