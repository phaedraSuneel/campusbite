...
class AddonsControllerTest < ActionController::TestCase
  ...
  test "should create addon" do
    assert_difference('Addon.count') do
      post :create, addon: { count: @addon.count, menu_category_id: @addon.menu_category_id, name: @addon.name, restuarant_id: @addon.restuarant_id }
    end
  ...
  test "should update addon" do
    put :update, id: @addon, addon: { count: @addon.count, menu_category_id: @addon.menu_category_id, name: @addon.name, restuarant_id: @addon.restuarant_id }
    assert_redirected_to addon_path(assigns(:addon))
  end
