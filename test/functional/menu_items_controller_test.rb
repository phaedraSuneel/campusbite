...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { item_name: @menu_item.item_name, menu_category_id: @menu_item.menu_category_id, price: @menu_item.price, short_description: @menu_item.short_description }
    end
  ...
  test "should update menu_item" do
    put :update, id: @menu_item, menu_item: { item_name: @menu_item.item_name, menu_category_id: @menu_item.menu_category_id, price: @menu_item.price, short_description: @menu_item.short_description }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
