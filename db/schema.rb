...
ActiveRecord::Schema.define(:version => 20140724061436) do
  ...
  create_table "group_item_menu_item_orders", :force => true do |t|
  ...
  create_table "join_us", :force => true do |t|
    t.string   "first_name"
    t.string   "last_name"
    t.string   "email"
    t.string   "restaurant_name"
  ...
  create_table "redeams", :force => true do |t|
    t.string   "item_id"
    t.string   "item_name"
  ...
  create_table "restaurant_suggestions", :force => true do |t|
    t.string   "first_name"
    t.string   "last_name"
    t.string   "email"
    t.string   "campus_name"
